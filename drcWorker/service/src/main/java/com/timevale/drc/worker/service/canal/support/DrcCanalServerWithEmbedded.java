...
/**
 * @see CanalServerWithEmbedded
 */
public class DrcCanalServerWithEmbedded extends AbstractCanalLifeCycle implements CanalServer, CanalService {

    private static final Logger logger = LoggerFactory.getLogger(DrcCanalServerWithEmbedded.class);
    private Map<String, CanalInstance> canalInstances = new ConcurrentHashMap<>();
    private DrcCanalInstanceGenerator canalInstanceGenerator;

    public DrcCanalServerWithEmbedded() {
    ...
    public boolean startInstance(final String destination) {
    ...
    public void subscribe(ClientIdentity clientIdentity) throws CanalServerException {
        ...
        if (position == null) {
            ...
            logger.info("subscribe successfully, use last cursor position:{} ", position);
        }
    ...
    public void setCanalInstanceGenerator(DrcCanalInstanceGenerator canalInstanceGenerator) {
